          ...
          child: Column(
            children: <Widget>[
              ...
              TextFormField(
                ...
                decoration: InputDecoration(hintText: 'Post Name',
              ...
              TextFormField(
                controller: _qualificationscontroller,
                 cursorColor: darkBlueColor,
                decoration: InputDecoration(hintText: 'Qualifications',
                enabledBorder: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(20)
                    ),
                    focusedBorder: OutlineInputBorder(
              ...
              TextFormField(
                controller: _deadlinecontroller,
                 cursorColor: darkBlueColor,
                decoration: InputDecoration(hintText: 'Submission Deadline',
                enabledBorder: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(20)
                    ),
                    focusedBorder: OutlineInputBorder(
              ...
              TextFormField(
                controller: _descriptioncontroller,
                 cursorColor: darkBlueColor,
                decoration: InputDecoration(hintText: 'Responsibilities/Description',
                enabledBorder: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(20)
                    ),
                    focusedBorder: OutlineInputBorder(
